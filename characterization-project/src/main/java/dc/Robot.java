...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    WPI_TalonSRX leftFollowerID18 = setupWPI_TalonSRX(18, Sides.FOLLOWER, false);
    leftFollowerID18.follow(leftMotor);

    WPI_TalonSRX rightMotor = setupWPI_TalonSRX(7, Sides.RIGHT, true);
    WPI_TalonSRX rightFollowerID1 = setupWPI_TalonSRX(1, Sides.FOLLOWER, false);    
